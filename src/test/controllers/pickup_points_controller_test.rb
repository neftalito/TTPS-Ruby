...
class PickupPointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pickup_point" do
    assert_difference("PickupPoint.count") do
      post pickup_points_url, params: { pickup_point: { address: @pickup_point.address, city: @pickup_point.city, enabled: @pickup_point.enabled, name: @pickup_point.name, province: @pickup_point.province } }
    end
  ...
  test "should update pickup_point" do
    patch pickup_point_url(@pickup_point), params: { pickup_point: { address: @pickup_point.address, city: @pickup_point.city, enabled: @pickup_point.enabled, name: @pickup_point.name, province: @pickup_point.province } }
